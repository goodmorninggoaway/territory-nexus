            ...
            <Box gap="small" pad="small" direction="row" fill>
                <Box pad="small" gap="small" overflow="auto" background="white" round="xsmall" basis="3/4">
                    <Accordion animate>
                        ...
                        <AccordionPanel label="4. Get existing locations from Territory Helper">
                            <Box background="light-2" style={{ height: '300px' }}>
                                Panel 3 contents
                            </Box>
                        </AccordionPanel>
                        <AccordionPanel label="5. Get territories from Territory Helper">
                            <Box background="light-2" style={{ height: '300px' }}>
                                Panel 3 contents
                            </Box>
                        </AccordionPanel>
                        <AccordionPanel label="6. Create a file to import in Territory Helper">
                            <Box background="light-2" style={{ height: '300px' }}>
                                Panel 3 contents
                            </Box>
                        </AccordionPanel>
